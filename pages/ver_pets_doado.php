<?php
    ...
    $sql = "SELECT id, nome, idade, cor, raca, genero, descricao, historia, tipo FROM pets WHERE emailUsuario = '$email'";
...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="ver_pets_doado.php">Pets Doado</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container mt-5">
        <h2 class="text-center mb-4">Pets Doado</h2>
